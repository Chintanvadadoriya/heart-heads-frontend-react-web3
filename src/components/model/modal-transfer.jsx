...
function ModalTransfer(props) {
    ...
    // console.log('showSendNFTModal', showSendNFTModal)
    // console.log('setShowSendNFTModal', setShowSendNFTModal)
    ...
    async function transferNFT() {
        try{
            ...
            console.log("1612 transfer-model")
        }
